...
module.exports = vander = async (vander, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Antilink group
        ...
        if (budy.match(`wa.me`)) {
        m.reply(`「 *ANTI LINK WA ME DETECTOR* 」`)
        if (!isBotAdmins) return m.reply(`*Bot Bukan Admin Mana Bisa Kick Decks*`)
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await vander.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, vander.user.name, m)
...
│───❲ *TEBAKK MENU* ❳
│    ╰≻ ${prefix}tebakk lagu
│    ╰≻ ${prefix}tebakk gambar
│    ╰≻ ${prefix}tebakk kata
│    ╰≻ ${prefix}tebakk kalimat
│    ╰≻ ${prefix}tebakk lirik
│    ╰≻ ${prefix}tebakk lontong
│╰≻note : tebakk , k nya 2 ya !!
╰────────────────⊱`
                let buttons = [{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }]
            await vander.sendButtonText(m.chat, buttons, anu, nyoutube, m, {mentions: ments})
            }
            ...
            case 'tebakk': {
                ...
                if (args[0] === "lagu") {
                    ...
                    vander.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: '😈Tebak Lagu' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, vander.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    vander.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: '😈Tebak Gambar' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, vander.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kata') {
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    vander.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: '😈Tebak kata' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, vandee.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    vander.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: '😈Tebak Kalimat' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, vander.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    vander.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: '😈Tebak Lirik' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, vander.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    vander.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: '😈Tebak Lontong' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, vander.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                vander.sendImage(m.chat, media.thumb, `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${isUrl(text)}\n⭔ Ext : MP3\n⭔ Resolusi : ${args[1] || '128kbps'}`, m)
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
                vander.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${isUrl(text)}\n⭔ Ext : MP3\n⭔ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
		...
		let { pinterest } = require('./lib/scraper')
                ...
                vander.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: m })
            }
            break
            case 'waifu': {
            	m.reply(mess.wait)
...
${ucapanWaktu}\n-Creator : @${ownernya.split('@')[0]}\n-Lu : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}`
            let ments = [ownernya, me, ini_mark]
            let buttons = [{ buttonId: 'menu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
...
╭──❍「 𝙄𝙉𝙁𝙊 𝘽𝙊𝙏 」❍
├ *Nama Bot* : ${pushname}
├ *Mode* : ${vander.public ? 'Public' : `Self`}
├ *Prefix* :「 MULTI-PREFIX 」
╰──❍
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            ...
            let ments = [ownernya, me, ini_mark]
                anu = `──❲ *SC VANDER MD* ❳
│
│   ╰≻ enc ? cek yt VANDER MD
│   ╰≻ no enc ? chat owner , karna fitur anti eror
│
│───❲ *JASA SEWA BOT* ❳
│    ╰≻ 3K perminggu
│    ╰≻ 5K perbulan
│    ╰≻ 8K permanen ( 1 group )
│    ╰≻ 10K permanen ( 2 group )
│
│───❲ *JASA JADI BOT / RUN* ❳
│    ╰≻ 20K : Jasrun
│    ╰≻ 30K : Jadi Bot
...
│
╰────────────────⊱`
                let buttons = [{ buttonId: 'owner', buttonText: { displayText: '👤Owner' }, type: 1 },{ buttonId: 'groupwa', buttonText: { displayText: '🌎Group Bot' }, type: 1 },{ buttonId: 'sewabot', buttonText: { displayText: '💸Sewa Bot Whatsapp' }, type: 1 }]
            await vander.sendButtonText(m.chat, buttons, anu, nyoutube, m, {mentions: ments})
            }
            break
            case 'sound1':
