...
Vander hanya menghilangkat bug, memperbagus & menyeting banyak hal
...
## My Project
* New script to replace this script [`look here`](https://github.com/VanderStore/NoEncPribadi) (`MULTI DEVICE `)
